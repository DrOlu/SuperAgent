...
Security invariants for SuperAgent's main process, which handles renderer-, assistant-, and provider-controlled input. Currently covers the rules for fetching untrusted URLs.
