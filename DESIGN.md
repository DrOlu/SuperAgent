...
This document defines SuperAgent's product-wide visual direction and the rules for choosing shared design
...
SuperAgent is a content-first AI workspace. The interface should feel calm, precise, and utilitarian so that
