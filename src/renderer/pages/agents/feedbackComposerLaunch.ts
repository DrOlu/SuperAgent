...
const FEEDBACK_SKILL = { name: 'superagent-feedback', filename: 'superagent-feedback' } satisfies LocalSkill
const FEEDBACK_DRAFT_TEXT = 'Use the superagent-feedback skill.'
