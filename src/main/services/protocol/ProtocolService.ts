...
export const CHERRY_STUDIO_PROTOCOL = 'superagent'

const DESKTOP_FILE_NAME = 'superagent-url-handler.desktop'
...
export class ProtocolService extends BaseService {
  ...
  protected async onInit() {
    ...
    //    - argv carries `superagent://...` → dispatch to URL handler; each handler
   ...
   * This allows the OS to open superagent:// URLs with this App.
   */
