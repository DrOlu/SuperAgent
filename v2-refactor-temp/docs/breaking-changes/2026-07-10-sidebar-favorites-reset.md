...
SuperAgent v2 resets migrated sidebar favorites to Chat, Agents, Translation, Paintings, and Knowledge Base. Legacy visible and hidden sidebar icon settings are not preserved.
