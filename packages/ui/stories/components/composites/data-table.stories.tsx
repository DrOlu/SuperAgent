...
const meta: Meta<typeof DataTable<Task>> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A shadcn/TanStack-powered data table with SuperAgent styling, optional max width, selection, header slots, empty state, scrolling, and controlled expanded rows.'
      }
    }
  },
  tags: ['autodocs']
