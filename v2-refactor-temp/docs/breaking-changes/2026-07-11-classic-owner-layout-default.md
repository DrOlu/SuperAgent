...
New SuperAgent installations default Chat conversations to the assistant-grouped classic layout and Agent sessions to the agent-grouped classic layout. The grouping and layout remain controlled by the same display-mode setting.
