...
/**
 * The official namespace. `com.superagent.*` as a whole is reserved; official mini
 * apps live under `com.superagent.miniapp.*`.
 *
 ...
 */
export const MINI_APP_OFFICIAL_ID_PREFIX = 'com.superagent.'
export const MINI_APP_BUILTIN_ID_PREFIX = 'com.superagent.miniapp.'
 ...
 * different author. `https://github.com/Hyperspace Technologies/` cannot be an entry for that reason,
