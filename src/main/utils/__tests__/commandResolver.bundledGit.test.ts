...
const UNICODE_BUNDLED_GIT =
  'D:\\常用软件\\SuperAgent\\resources\\app.asar.unpacked\\resources\\binaries\\win32-x64\\git\\cmd\\git.exe'
...
describe('findExecutableInEnv – bundled MinGit resolver ordering', () => {
  ...
  it('uses the original bundled git path when SuperAgent is installed under a Unicode directory', async () => {
