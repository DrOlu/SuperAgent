...
describe('RadeonCloudBenefits', () => {
  it('renders localized benefit copy and the attributed Token Factory link', () => {
    ...
    expect(Object.fromEntries(url.searchParams)).toEqual({ source: 'superagent' })
  ...
  it('provides complete English and Chinese benefit copy', () => {
    ...
    expect(zhCN.settings.provider.radeon_cloud.benefits.title).toContain(' 10 ')
    expect(zhCN.settings.provider.radeon_cloud.benefits.title).not.toContain('1000 ')
    expect(zhCN.settings.provider.radeon_cloud.benefits.description).toContain('1000 –1.11 ')
    expect(zhCN.settings.provider.radeon_cloud.benefits.description).toContain(' Token ')
    expect(zhCN.settings.provider.radeon_cloud.benefits.description).toContain('')
  })
})
