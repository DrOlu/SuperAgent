...
describe('resolveMountedMcpServers', () => {
  ...
  it('withdraws SuperAgent Assistant host servers once the session is channel-linked', () => {
...
describe('buildMcpServers', () => {
  ...
  it('injects assistant file tools only for SuperAgent Assistant sessions', () => {
