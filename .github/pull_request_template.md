...
1. Consider creating this PR as draft: https://github.com/Hyperspace Technologies/superagent/blob/main/CONTRIBUTING.md
-->
...
- [ ] Documentation: A [user-guide update](https://docs.superagent.ng) was considered and is present (link) or not required. Check this only when the PR introduces or changes a user-facing feature or behavior.
