...
describe('parseWorkbook — sheets, values, hidden', () => {
  ...
  beforeAll(async () => {
    ...
    s1.getCell('A6').value = { text: 'SuperAgent', hyperlink: 'https://github.com/DrOlu/SuperAgent' }
  ...
  it('hyperlink: text shown, hyperlink field populated', () => {
    ...
    expect(cell.text).toBe('SuperAgent')
    expect(cell.hyperlink).toBe('https://github.com/DrOlu/SuperAgent')
  })
