...
const NON_VISION_IMAGE_OCR_ERROR_MESSAGE =
  "The selected model isn't configured for image input, and SuperAgent couldn't extract readable text from the attachment. Enable Vision for this model in Provider Settings, choose another vision-capable model, or remove the image and try again."
