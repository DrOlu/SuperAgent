...
This document outlines the detailed plan for migrating SuperAgent from antd + styled-components to shadcn/ui + Tailwind CSS. We will adopt a progressive migration strategy to ensure system stability and development efficiency, while gradually implementing UI refactoring in collaboration with UI designers.
...
- Official Shadcn and approved SuperAgent product semantics share the unprefixed public namespace
