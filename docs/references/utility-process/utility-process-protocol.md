...
1. The host builds the environment and init data, resolves `out/utility-process/<entry>.js`, and forks with `stdio: 'pipe'`, `args: []`, `execArgv: []`, and `serviceName: SuperAgent.UtilityProcess.<id>`.
