...
The entry is shown when the exact `persist:superagent` Local Storage key or `SuperAgent` IndexedDB database exists. Original v1 browser and filesystem sources are preserved for the next migration.
