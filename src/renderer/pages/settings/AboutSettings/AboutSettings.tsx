...
const AboutSettings: FC = () => {
  ...
  const mailto = async () => {
    const email = 'support@superagent.ng'
    const subject = 'SuperAgent Feedback'
  ...
  const showReleases = async () => {
    ...
    openSmartMiniApp({
      appId: 'superagent-releases',
      name: t('settings.about.releases.title'),
      url: `file://${appPath}/resources/superagent/releases.html?theme=${theme === ThemeMode.dark ? 'dark' : 'light'}`,
      logo: AppLogo
    })
  }
    ...
    <SettingsContentColumn theme={theme}>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 py-1">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="flex min-h-18 flex-col items-start justify-center">
              <div className="mb-1 font-bold text-foreground text-lg">SuperAgent</div>
      ...
      <SettingGroup theme={theme}>
        ...
        <AboutActionRow
          ...
          onAction={() => onOpenWebsite('https://www.superagent.ng/careers')}
        />
        <Divider className="my-3" />
        <AboutActionRow
