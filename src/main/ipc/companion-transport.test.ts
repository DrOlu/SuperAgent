// Tests for the transport-selection + WSL-distro plumbing in ipc/companion.ts.
// These cover the branches the existing companion.test.ts (mintCompanionId) and
...
vi.mock('../companion/sshSecretStore', () => ({
