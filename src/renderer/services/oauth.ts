...
export const oauthWith302AI = async (setKey) => {
  const authUrl = 'https://dash.302.ai/sso/login?app=superagent.ng&name=Cherry%20Studio'
...
export const providerCharge = async (provider: string) => {
  ...
  const chargeUrlMap = {
    ...
    ppio: {
      url: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_superagent&redirect=/billing',
      width: 900,
      height: 700
    },
    '302ai': {
...
export const providerBills = async (provider: string) => {
  ...
  const billsUrlMap = {
    ...
    ppio: {
      url: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_superagent&redirect=/billing/billing-details',
      width: 900,
      height: 700
    },
    '302ai': {
