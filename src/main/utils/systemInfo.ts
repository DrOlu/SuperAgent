...
export function generateUserAgent(): string {
  ...
  return `Mozilla/5.0 (${systemInfo.osString}; ${systemInfo.archString}) AppleWebKit/537.36 (KHTML, like Gecko) SuperAgent/${systemInfo.appVersion} Chrome/124.0.0.0 Safari/537.36`
}
