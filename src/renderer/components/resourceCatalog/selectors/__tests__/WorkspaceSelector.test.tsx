...
const WORKSPACES = [
  ...
  },
  {
    id: 'workspace-beta',
    name: 'superagent-1',
    path: '/Users/jd/projects/superagent-1',
    type: 'user',
    orderKey: 'a1',
...
describe('WorkspaceSelector', () => {
  it('refreshes the open list after a workspace membership notification', async () => {
    ...
    expect(screen.getByRole('option')).toHaveTextContent('superagent-1')
  })
  ...
  it('loads workspaces and renders folder rows', () => {
    ...
    expect(options[0]).toHaveTextContent('superagent')
    expect(options[1]).toHaveTextContent('superagent-1')
    expect(screen.queryByText('/Users/jd/superagent')).not.toBeInTheDocument()
  })
  ...
  it('filters workspaces by name or path', () => {
    ...
    expect(screen.queryByRole('option', { name: /\/Users\/jd\/superagent/ })).not.toBeInTheDocument()
    expect(screen.getByRole('option', { name: /superagent-1/ })).toBeInTheDocument()
  })
  ...
  it('fires onChange with the selected workspace id', async () => {
    ...
    fireEvent.click(screen.getByText('superagent-1'))
  ...
  it('previews capped affected resource summaries before deleting a workspace', async () => {
    ...
    expect(dialog).toHaveTextContent('superagent')
    ...
    expect(dialog).toHaveTextContent('/Users/jd/superagent')
