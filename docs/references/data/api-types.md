...
This directory contains the type definitions and utilities for SuperAgent's Data API system, which provides type-safe IPC communication between renderer and main processes.
