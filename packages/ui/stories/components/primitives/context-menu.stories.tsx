...
const meta: Meta<typeof ContextMenu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A context menu component that displays a menu of actions when the user right-clicks. Based on Radix UI Context Menu primitive, styled to match the SuperAgent design system.'
      }
    }
  },
  tags: ['autodocs']
