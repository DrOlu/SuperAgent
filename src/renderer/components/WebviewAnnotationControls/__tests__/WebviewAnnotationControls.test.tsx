...
describe('WebviewAnnotationControls', () => {
  beforeEach(async () => {
    ...
    // The assertions below expect the zh-CN labels; pin the language so the
    // test is independent of the host machine's navigator.language.
    mockPreferenceState.set('app.language', 'zh-CN')
    await i18n.changeLanguage('zh-CN')
    // TEMP DEBUG
    console.log('DEBUG i18n.language =', i18n.language, '| t =', i18n.t('webview.annotation.enable_mode'))
