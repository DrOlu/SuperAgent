...
Throughput: ~200 dispatch/s at single-process better-sqlite3 throughput, well above SuperAgent's largest scenario (1000+ knowledge bases, each with concurrency=5, never exceeds globalMaxConcurrency=50 simultaneous running jobs).
