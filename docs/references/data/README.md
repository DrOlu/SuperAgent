---
description: Entry point for SuperAgent data systems - decision guide across BootConfig, Cache, Preference, DataApi, app_state
sources:
  - src/main/data
  - src/renderer/data
  - src/shared/data
...
This is the main entry point for SuperAgent's data management documentation. The application uses four data systems based on data characteristics and loading requirements.
