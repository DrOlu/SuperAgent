...
describe('agentsFilesystemMigration', () => {
  ...
  it('matches the Claude SDK project directory name for the observed legacy workspace', () => {
    expect(
      claudeProjectDirectoryName('/Users/suyao/Library/Application Support/SuperAgentDev/Data/Agents/cvqr0cflx')
    ).toBe('-Users-suyao-Library-Application-Support-SuperAgentDev-Data-Agents-cvqr0cflx')
  })
