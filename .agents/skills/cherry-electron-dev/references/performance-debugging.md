...
Use this reference for SuperAgent lag, jank, CPU, memory, leak, startup, and
...
if (!page || (await page.title()) !== "SuperAgent") {
  throw new Error("Bound SuperAgent main target not found")
}
...
system before attributing growth to SuperAgent.
