...
An agentic variant that read the codebase for each key's UI context was measured against this pipeline and removed — it cost roughly 50× more for no quality gain that survived scrutiny. See [PR #18510](https://github.com/DrOlu/SuperAgent/pull/18510) if that comes up again.
