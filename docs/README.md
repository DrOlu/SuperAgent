...
| Document | Description |
|----------|-------------|
| [Data System Reference](./references/data/README.md) | Entry point for SuperAgent data systems - decision guide across BootConfig, Cache, Preference, DataApi, app_state |
...
| Document | Description |
|----------|-------------|
| [SuperAgent LAN Transfer Protocol Specification](./references/lan-transfer/README.md) | LAN transfer protocol spec for desktop-mobile sync covering mDNS discovery, TCP handshake, and file transfer |
...
| [Memory Feature Overview](./references/memory/overview.md) | Comparison of the three memory mechanisms in SuperAgent — Agent File Memory, Knowledge Base, and MCP Memory — plus the status of the v1 Global Memory feature |

### Mini App

| Document | Description |
|----------|-------------|
| [Mini App Reference](./references/mini-app/README.md) | Entry point for building a SuperAgent mini app — what a package is, the host API, and where each rule lives |
