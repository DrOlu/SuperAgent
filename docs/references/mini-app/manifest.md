...
| `com.superagent.*` is reserved | Official apps only; a package from any other source using it is refused |
...
```json
{
  ...
  "name": { "en": "My Game", "zh": "" },
  "description": { "en": "A tiny sample game.", "zh": "" },
  "version": "1.0.0",
  "entry": "index.html",
  ...
  "releaseNotes": { "en": "Fixes a save bug.", "zh": "" },
  "update": {
