...
export const REGISTRY_URL_GITHUB = `https://raw.githubusercontent.com/DrOlu/SuperAgent/refs/heads/${REMOTE_BRANCH}/${REMOTE_SUBPATH}`
export const REGISTRY_URL_GITCODE = `https://raw.gitcode.com/DrOlu/SuperAgent/raw/${encodeURIComponent(REMOTE_BRANCH)}/${REMOTE_SUBPATH}`
