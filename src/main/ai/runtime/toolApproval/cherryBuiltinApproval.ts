...
/**
 * Assistant MCP tools safe to auto-approve for local SuperAgent Assistant sessions: `navigate`, which
...
/** SuperAgent Assistant-only file tools live on their own session-scoped MCP server. */
