...
The retired inventory extraction and validation scripts are no longer part of this tool. Separating permanent product definitions from migration inputs remains tracked in [#19192](https://github.com/DrOlu/SuperAgent/issues/19192).
