...
Download it from [hyperspace.ng/download](https://hyperspace.ng/download) or the [GitHub releases page](https://github.com/DrOlu/paseo/releases). Open the app and the daemon starts automatically. Nothing else to install.
