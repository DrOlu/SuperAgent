---
description: Comparison of the three memory mechanisms in SuperAgent — Agent File Memory, Knowledge Base, and MCP Memory — plus the status of the v1 Global Memory feature
sources:
...
SuperAgent provides three distinct memory mechanisms. They differ in who they serve, how they persist, and where they are stored. Use this reference to pick the right one for your use case and to understand why enabling one does not affect the others.
