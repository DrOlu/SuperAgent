  ...
  application: {
    getPath: vi.fn((key: string, filename?: string) => {
      const bases: Record<string, string> = {
        ...
        'app.database.file': join(userData, 'Data', 'superagent.sqlite'),
...
const livePath = () => join(dataDir(), 'superagent.sqlite')
const asideRel = `Data/superagent.sqlite.pre-restore-${RID}`
