...
const CLI_TOOLS: readonly Tool[] = [
  ...
  },
  {
    ...
    description:
      'Install a reusable CLI into SuperAgent’s isolated mise environment. Use a name/recipe returned by cli_search, or exact executable and mise recipe derived from trusted public documentation. The operation requires user approval and accepts the same backends as BinaryManager; validation errors explain how to correct the recipe.',
