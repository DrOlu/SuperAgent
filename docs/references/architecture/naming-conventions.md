...
This document defines naming rules for files, directories, and identifiers across the SuperAgent monorepo. It encodes both industry consensus (React/TypeScript, Node.js, shadcn/Next.js) and project-specific conventions.
