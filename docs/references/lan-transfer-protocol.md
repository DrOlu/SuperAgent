# SuperAgent LAN Transfer Protocol Specification

> Version: 1.0
> Last Updated: 2025-12

This document defines the LAN file transfer protocol between the SuperAgent desktop client (Electron) and mobile client (Expo).
...
| Property | Value |
|----------|-------|
| Service Type | `superagent` |
| Protocol | `tcp` |
| Full Service ID | `_superagent._tcp` |
...
export const LAN_TRANSFER_SERVICE_TYPE = 'superagent'
export const LAN_TRANSFER_SERVICE_FULL_NAME = '_superagent._tcp'
...
1. **mDNS Service Publishing**: Publish `_superagent._tcp` service on TCP port `53317`
