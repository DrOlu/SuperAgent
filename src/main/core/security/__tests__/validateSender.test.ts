...
const APP_ROOT = resolve('/Applications/SuperAgent.app/Contents/Resources/app.asar')
...
describe('isAppRendererUrl', () => {
  ...
  it('trusts a packaged app page when the launch path reaches the app through a directory link', () => {
    ...
    const appRootFromLaunchPath = join(linkedProgramsDir, 'SuperAgent', 'resources', 'app.asar')
    const realAppRoot = join(realProgramsDir, 'SuperAgent', 'resources', 'app.asar')
  ...
  it('trusts a packaged app page when the renderer path reaches the app through a directory link', () => {
    ...
    const linkedProgramsDir = join(fixtureRoot, 'linked-programs')
    const realAppRoot = join(realProgramsDir, 'SuperAgent', 'resources', 'app.asar')
    const appRootFromRendererPath = join(linkedProgramsDir, 'SuperAgent', 'resources', 'app.asar')
