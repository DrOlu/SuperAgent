...
const LEGACY_DATABASE_NAME = 'SuperAgent'
const LEGACY_PERSISTED_STATE_KEY = 'persist:superagent'
const LEGACY_CLEANUP_RETRY_MARKER_KEY = 'superagent:legacy-v1-cleanup-pending'
