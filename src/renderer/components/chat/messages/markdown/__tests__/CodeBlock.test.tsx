...
describe('CodeBlock', () => {
  ...
  describe('rendering', () => {
    ...
    it.each([
      '/Users/suyao/Library/Application Support/SuperAgentDev/.claude/skills/guizang-ppt-skill/',
      './src/index.ts',
      '../packages/ui/src/'
    ...
    it('should render ClickableFilePath for text code fences containing a single path', () => {
      const path = '/Users/suyao/Library/Application Support/SuperAgentDev/.claude/skills/guizang-ppt-skill/'
