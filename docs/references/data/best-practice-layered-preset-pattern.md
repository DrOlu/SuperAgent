...
> **Note:** The `Provider` example below is for illustration purposes only and does not represent the actual provider implementation in SuperAgent. Your actual data structure will vary based on your specific requirements.
