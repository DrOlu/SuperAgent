...
//=> '/Users/alice/Library/Application Support/SuperAgent/Data/Files'
...
|-----------|-----------|----------|
| `cherry.*` | Generic infra under `~/.superagent` | `cherry.home`, `cherry.bin` |
...
|-----|-------------------|------|
| `feature.mcp.oauth` | `~/.superagent/config/mcp/oauth` | Under `config/`, not `mcp/` |
