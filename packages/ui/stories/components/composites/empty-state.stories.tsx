...
const meta: Meta<typeof EmptyState> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A centered placeholder for empty lists, search results, and onboarding slots. Ships with presets for common SuperAgent domains and accepts custom icons, copy, and actions.'
      }
    }
  },
  tags: ['autodocs'],
