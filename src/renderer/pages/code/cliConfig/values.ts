...
/** True when a model entry was injected by SuperAgent (its `envKey` starts with `CHERRY_`). */
...
/** Find the provider key SuperAgent manages (prefixed with `CHERRY_PROVIDER_PREFIX`). */
