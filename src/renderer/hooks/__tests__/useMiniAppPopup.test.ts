...
describe('useMiniAppPopup', () => {
  ...
  describe('openMiniApp', () => {
    ...
    it('should not write a new keep-alive array when the app is already at the tail (#hyperspace keepalive regression)', async () => {
  ...
  describe('openSmartMiniApp', () => {
    ...
    it('should open file URLs externally with openPath without TabsProvider', async () => {
      ...
      expect(mocks.request).toHaveBeenCalledWith(
        ...
        '/Applications/SuperAgent/resources/releases.html'
      )
